---
title: 'Lição 4: Anotações e salvamento'
...
Mas você precisará salvá-las como variáveis a fim de usá-as em sua rotulagem; o seguinte bloco de código cria duas dessas variáveis: 
```{r latest date}
...
Ao concluir esta atividade, salve-a clicando na guia Arquivo no canto superior esquerdo do console RStudio e selecionando Salvar. Você usará este documento (ou qualquer outra atividade do R que tenha concluído e salvo neste curso) para uma próxima atividade.